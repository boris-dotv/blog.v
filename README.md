...
## 4. 目标
### 20251109 - 20261109 目标 (附进度)




* (1) 博客 -- 通过博客我要得到: 1. 成为 Doruv 竞赛体系认可的 Top Coder (Python / C++); 2. 在 Deep Research 领域有一定影响力 (两篇具有社区认可度的 blog / 一篇顶会).
    ...
    - **MTProto 博客** -- 1. 正文: 未开始; 2. 实践: 打通客户端服务端的信息传递 C++ 线路, 构建了第一个属于自己的 bot.
...
* (3) 音乐
    - **吉他** (Ins 频道): 未开始, 预计 2026.2. 开始.


* (4) **精力** (组成我的最重要部分) -- 13:10 午休 & 23:45 睡觉 & 全天社交媒体使用时间小于 30 mins 的日子有:
    - 202511**, 
...
![telegram ecosystem](image-1.png)
